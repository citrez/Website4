...
<h2>
  <p style="text-align: center;">
    A collection of things that I love to use<br>Enjoy!
    </p>
</h2>
...
<ul class="toc fa-ul">
  <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span><a href = "#R">R</a></li>
  <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span><a href = "#Bloggers">Bloggers</a></li>
  <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span><a href = "#DataVis">DataVis</a></li>
  <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span><a href = "#Books-Sites">Books-Sites</a></li>
</ul>
...
### Commonly used cheat sheets
[Rmarkdown]()


### Less-well-known Packages {#packages}
