...
There is no 1 solution that will fix this perfectly in every situation, but in this article I'd like to introduce a few techniques that may be able to get you at least some of the way.
...
[fuzz.ratio('James Bond',word2) for word2 in ('James Bonds', 'James B')  ]
```
